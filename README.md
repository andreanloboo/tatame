...
Inclui uma **Biblioteca** de movimentações (guardas, raspagens, passagens, finalizações, controles e escapes), com busca, filtro por categoria e um tutorial resumido por técnica: ideia central, passo a passo, detalhes, erros comuns, conceito de referência (baseado em fundamentos clássicos e nos sistemas de John Danaher), técnicas relacionadas e link para vídeos no YouTube.
